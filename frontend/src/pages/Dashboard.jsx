      ...
      <section className="overflow-hidden rounded-[32px] border border-amber-700/30 bg-gradient-to-br from-amber-950/40 via-amber-900 to-amber-950 p-7 text-white shadow-[0_20px_60px_-20px_rgba(139,35,60,0.3)] sm:p-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#a97d53]/20 bg-[#4d2a2d]/40 px-4 py-2 text-sm text-[#c7a965]">
              <Brain size={14} />
              <span>Workspace ready</span>
            </div>
            <h1 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl text-[#f8ebd5]">
              Welcome back
            </h1>
            <p className="mt-3 text-sm leading-7 text-[#e8dcc8] sm:text-base">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <section className="rounded-[28px] border border-amber-700/40 bg-amber-900/30 p-6 shadow-[0_8px_30px_-10px_rgba(0,0,0,0.5)] backdrop-blur">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[#c7a965]">Quick actions</p>
              <h2 className="mt-1 text-2xl font-semibold text-[#f8ebd5]">Next steps</h2>
            </div>
          </div>
        ...
        <section className="rounded-[28px] border border-amber-700/40 bg-amber-900/30 p-6 shadow-[0_8px_30px_-10px_rgba(0,0,0,0.5)] backdrop-blur">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[#c7a965]">Activity</p>
              <h2 className="mt-1 text-2xl font-semibold text-[#f8ebd5]">Recent activity</h2>
            </div>
          </div>
          <div className="mt-6">
            <RecentActivity />
